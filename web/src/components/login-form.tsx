                        ...
                        <FieldGroup>
                            ...
                            <Field className="grid grid-cols-3 gap-4">
                                <Button variant="outline" type="button">
                                    ...
                                    <span className="sr-only">{t("login.providers.apple")}</span>
                                </Button>
                                <Button variant="outline" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
                                    ...
                                    <span className="sr-only">{t("login.providers.google")}</span>
                                </Button>
                                <Button variant="outline" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path
                                    ...
                                    <span className="sr-only">{t("login.providers.meta")}</span>
                                </Button>
                            </Field>
