...
import {CreateOrganizationModal, type OrganizationPreview} from "@/components/create-organization-modal"
...
const partners: Partner[] = [
    {
        ...
        description: "European cloud provider with competitive pricing and excellent performance. Known for reliable infrastructure and great value for money.",
        documentationUrl: "",
        color: "#d50c2d"
    },
    {
        ...
        description: "Developer-friendly cloud platform with simple pricing and intuitive interface. Perfect for startups and small to medium projects.",
        documentationUrl: "",
        color: "#0080ff"
    },
    {
        ...
        description: "High-performance cloud infrastructure with global presence and SSD storage. Offers bare metal and cloud compute options.",
        documentationUrl: "",
        color: "#007bfc"
    },
    {
        ...
        description: "Amazon's comprehensive cloud platform with extensive services and global infrastructure. Best for enterprise and complex workloads.",
        documentationUrl: "",
        color: "#ff9900"
    },
    {
        ...
        description: "Microsoft's cloud platform with strong integration with Microsoft ecosystem. Excellent for enterprise Windows workloads.",
        documentationUrl: "",
        color: "#0078d4"
    }
]
...
export function ServerSelectionDialog({isOpen, onClose}: ServerSelectionDialogProps) {
    const [deviceCode, setDeviceCode] = React.useState("")
    const [isCopied, setIsCopied] = React.useState(false)
    const [isRegistering, setIsRegistering] = React.useState(false)
    const [selectedProvider, setSelectedProvider] = React.useState<Partner>(partners[0])
    const [organizations, setOrganizations] = React.useState<OrganizationPreview[]>(defaultOrganizations)
        ...
        return (
            ...
            >
                ...
                <div className="flex min-h-full items-center justify-center p-4">
                    <div
                        className="relative w-full max-w-lg transform overflow-hidden rounded-lg bg-background shadow-2xl transition-all"
                    >
                        <button
                            type="button"
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex flex-col gap-2 items-start">
                                <Logo size="md"/>
                                <h2 className="text-2xl font-semibold">Enter Connection Code</h2>
                                <p className="text-muted-foreground">
                                    Please enter the code you get when you launched Winterflow.
                                </p>
                            </div>
    ...
    return (
        ...
        >
            ...
            <div className="flex min-h-full items-center justify-center p-0">
                <div
                    className="relative w-full h-full lg:max-w-7xl lg:max-h-[90vh] lg:h-auto transform overflow-hidden lg:rounded-lg bg-background shadow-2xl transition-all">
                    {/* Close button */}
                    <button
                        type="button"
                        className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none cursor-pointer"
                        ...
                        <div className="flex-1 lg:w-1/2 p-6 lg:p-8">
                            ...
                            <div className="mb-8">
                                <div className="rounded-lg border p-6">
                                    <h3 className="mb-4 text-sm font-medium text-muted-foreground">Recommended
                                        Providers</h3>
                                    ...
                                    <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
                                        {partners.map((partner) => (
                                            <button
                                                ...
                                                style={{
                                                    borderColor: selectedProvider.id === partner.id ? partner.color : undefined
                                                }}
                                            >
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-accent/30 rounded-lg border-l-4"
                                             style={{borderLeftColor: selectedProvider.color}}>
                                            <div className="flex items-start gap-4">
                                                <div className="flex-1">
                                                    <h4 className="font-semibold text-sm mb-2">{selectedProvider.name}</h4>
                                                ...
                                                <img
                                                    ...
                                                    onClick={() => window.open(selectedProvider.url, '_blank', 'noopener,noreferrer')}
                                                />
                                            </div>
                                        </div>
                            ...
                            <div className="mb-8">
                                <div className="rounded-lg border p-6">
                                    <h3 className="mb-4 text-sm font-medium text-muted-foreground">Requirements</h3>
                        ...
                        <div className="w-full lg:w-1/2 border-t lg:border-t-0 lg:border-l bg-muted/50 p-6 lg:p-8">
                            ...
                            <div className="space-y-6">
                                ...
                                {organizations.length > 0 && (
                                    <div className="rounded-lg border p-6">
                                        <div className="mb-4">
                                            <h3 className="text-sm font-medium text-muted-foreground">Select Organization</h3>
                                        </div>
                  ...
                  <span
                      className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/10 text-sm font-medium">
                    1
                  </span>
                                            <div className="flex-1 min-w-0">
                                                <p className="font-medium">Install the WinterFlow Agent</p>
                    ...
                    2
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="mt-1 text-muted-foreground">
                                                    After installation, you'll receive a 6-character code to connect
                                                    your server.
                                                </p>
                                ...
                                <div className="flex justify-center">
                                    <Button
                                        ...
                                        disabled={deviceCode.length !== 6 || isRegistering || !selectedOrganizationId}
                                        onClick={handleConnectAgent}
                                    >
                                        {isRegistering ? "Connecting..." : "Connect Server"}
                                    </Button>
