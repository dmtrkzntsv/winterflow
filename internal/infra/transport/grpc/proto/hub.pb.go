...
// AgentEvent is an unsolicited, fire-and-forget push from the agent (no
// response expected). The hub forwards it verbatim onto the region's events
// queue as a bus.EventMessage.
type AgentEvent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Base  *BaseMessage           `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	// bus.EventKind value, e.g. "apps.status".
...
func (x *AgentEvent) GetBase() *BaseMessage {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *AgentMessage) GetEvent() *AgentEvent {
	if x != nil {
		if x, ok := x.Message.(*AgentMessage_Event); ok {
			return x.Event
		}
	}
	return nil
...
func (*AgentMessage_Event) isAgentMessage_Message() {}
...
const file_internal_infra_transport_grpc_proto_hub_proto_rawDesc = "" +
	...
	"\x04base\x18\x01 \x01(\v2\x13.proto.BaseResponseR\x04base\"b\n" +
	"\n" +
	"AgentEvent\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.proto.BaseMessageR\x04base\x12\x12\n" +
	"\x04kind\x18\x02 \x01(\tR\x04kind\x12\x18\n" +
	"\apayload\x18\x03 \x01(\fR\apayload\"\xd0\x01\n" +
	...
	"\x05event\x18\x02 \x01(\v2\x11.proto.AgentEventH\x00R\x05event\x125\n" +
...
var file_internal_infra_transport_grpc_proto_hub_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_internal_infra_transport_grpc_proto_hub_proto_goTypes = []any{
	...
	(*AgentEvent)(nil),             // 8: proto.AgentEvent
	(*RequestEnvelope)(nil),        // 9: proto.RequestEnvelope
	(*ResponseEnvelope)(nil),       // 10: proto.ResponseEnvelope
	(*ServerCommand)(nil),          // 11: proto.ServerCommand
	(*AgentMessage)(nil),           // 12: proto.AgentMessage
	nil,                            // 13: proto.RegisterAgentRequest.CapabilitiesEntry
	nil,                            // 14: proto.RegisterAgentRequest.FeaturesEntry
	(*timestamppb.Timestamp)(nil),  // 15: google.protobuf.Timestamp
}
var file_internal_infra_transport_grpc_proto_hub_proto_depIdxs = []int32{
	15, // 0: proto.BaseMessage.timestamp:type_name -> google.protobuf.Timestamp
	15, // 1: proto.BaseResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	13, // 4: proto.RegisterAgentRequest.capabilities:type_name -> proto.RegisterAgentRequest.CapabilitiesEntry
	14, // 5: proto.RegisterAgentRequest.features:type_name -> proto.RegisterAgentRequest.FeaturesEntry
	...
	1,  // 10: proto.AgentEvent.base:type_name -> proto.BaseMessage
	1,  // 11: proto.RequestEnvelope.base:type_name -> proto.BaseMessage
	2,  // 12: proto.ResponseEnvelope.base:type_name -> proto.BaseResponse
	7,  // 13: proto.ServerCommand.heartbeat_response:type_name -> proto.AgentHeartbeatResponse
	9,  // 14: proto.ServerCommand.request:type_name -> proto.RequestEnvelope
	6,  // 15: proto.AgentMessage.heartbeat:type_name -> proto.AgentHeartbeat
	8,  // 16: proto.AgentMessage.event:type_name -> proto.AgentEvent
	10, // 17: proto.AgentMessage.response:type_name -> proto.ResponseEnvelope
	4,  // 18: proto.AgentService.RegisterAgent:input_type -> proto.RegisterAgentRequest
	12, // 19: proto.AgentService.AgentStream:input_type -> proto.AgentMessage
	5,  // 20: proto.AgentService.RegisterAgent:output_type -> proto.RegisterAgentResponse
	11, // 21: proto.AgentService.AgentStream:output_type -> proto.ServerCommand
